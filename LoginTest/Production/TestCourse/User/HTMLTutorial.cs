...
namespace TestCompa.Production.TestCourse.User.HTMLTutorial
{
    public class CourseTests
    {
        ...
        private void Navigate()
        {
            ...
            IWebElement course = driver.FindElement(By.XPath("//a[contains(text(),'HTML Tutorial')]"));
        ...
        private void gotoLearn()
        {
            Login();
            Navigate();
            IWebElement gotoLearn = driver.FindElement(By.XPath("//a[@href='/learn/course/html-tutorial?action=continue_learning']"));
            gotoLearn.Click();
            Thread.Sleep(2000);
        }
