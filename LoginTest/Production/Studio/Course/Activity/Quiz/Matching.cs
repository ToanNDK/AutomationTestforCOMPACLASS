...
namespace TestCompa.Production.Studio.Course.Activity.Quiz.Matching
{
    [TestFixture]
    [Category("Quiz")]
    public class Matching
    {
        ...
        {
            CourseBuilder();
            IWebElement title = driver.FindElement(By.XPath("//p[starts-with(normalize-space(), 'Matching')]"));
            title.Click();
            Thread.Sleep(1000);
