...
namespace TestCompa.Server.Learn.Discovery
{
    [TestFixture]
    [Category("Discovery")]
    public class Discovery
    {
        ...
        public void NavigateToDiscovery()
        {
            ...
            discoverybtn.Click();
            Thread.Sleep(2000);
            Assert.That(driver.Url, Does.Contain("http://10.10.10.30/discovery"), "No navigate to discovery!");
        }
        ...
        public void ViewCourseFree()
        {
            ...
            Assert.That(driver.Url, Does.Contain("http://10.10.10.30/vn/discovery/free-courses"), "No navigate to view all free courses!");
        ...
        public void ViewCourse()
        {
            ...
            Assert.That(driver.Url, Does.Contain("http://10.10.10.30/vn/discovery/popular-courses"), "No navigate to view all courses!");
        }
        ...
        public void ViewClass()
        {
            ...
            Assert.That(driver.Url, Does.Contain("http://10.10.10.30/vn/discovery/upcoming-classes"), "No navigate to view all upcoming class!");
        }
        ...
        public void Tag()
        {
            ...
            tag.Click();
            Thread.Sleep(500);
            Assert.That(driver.Url, Does.Contain("http://10.10.10.30/discovery?tag=1"), "Unable to click tag!");
