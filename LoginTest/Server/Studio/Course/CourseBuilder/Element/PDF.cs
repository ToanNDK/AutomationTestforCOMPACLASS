...
namespace TestCompa.Server.CourseBuilder.PDF
{
    [TestFixture]
    [Category("Element")]
    public class PDF
    {
        ...
        {
            courseBuilder();
            IWebElement title = driver.FindElement(By.XPath("//p[starts-with(normalize-space(), 'PDFBlock')]"));
            title.Click();
            Thread.Sleep(1000);
            ...
            IWebElement textElement = driver.FindElement(By.XPath("//div[img[@alt='Pdf block icon']]"));
        ...
        public void addContent()
        {
            ...
            IWebElement addPdf = driver.FindElement(By.XPath("//button[.//p[text()='Click to add pdf']]"));
            addPdf.Click();
            Thread.Sleep(1000);

            IWebElement inputFile = driver.FindElement(By.XPath("//input[@type='file']"));
            inputFile.SendKeys(@"D:\KPIM\Blog\Blog HTML\HTML Css JavaScript\HTML Responsive Web Design\HTML_Responsive_Web_Sign.pdf");
            Thread.Sleep(1000);
        }
