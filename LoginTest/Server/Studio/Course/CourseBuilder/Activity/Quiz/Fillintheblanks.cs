...
namespace TestCompa.Server.Studio.Course.Activity.Quiz.FillIntheblanks
{
    [TestFixture]
    [Category("Quiz")]
    public class Fillintheblanks
    {
        ...
        {
            CourseBuilder();
            IWebElement title = driver.FindElement(By.XPath("//p[starts-with(normalize-space(), 'Fill in the blanks')]"));
            title.Click();
            Thread.Sleep(1000);
